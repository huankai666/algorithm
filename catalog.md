...
- **稳定**：如果排序前a在b前面，且a=b，排序后a仍然在b的前面，则称排序算法稳定。
- **不稳定**：如果排序前a在b前面，且a=b，排序后a可能在b的后面，则称排序算法不稳定。
- **时间复杂度**：对排序数据的总的操作次数。反映当n变化时，操作次数呈现什么规律。
- **空间复杂度：**是指算法在计算机内执行时所需存储空间的度量，它也是数据规模n的函数。 

### 4.1.4 算法介绍

#### 4.1.4.1 冒泡排序（Bubble Sort）
...
2. 图片演示
   ...
   ![image-20210413172847461](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20210413172847461.png)
